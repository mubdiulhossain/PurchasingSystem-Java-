...
CREATE TABLE `do_item` (
  ...
  PRIMARY KEY (`do_id`,`itemID`),
  KEY `item_idx` (`itemID`),
  CONSTRAINT `do` FOREIGN KEY (`do_id`) REFERENCES `delivery_order` (`do_id`),
...
LOCK TABLES `do_item` WRITE;
/*!40000 ALTER TABLE `do_item` DISABLE KEYS */;
INSERT INTO `do_item` VALUES ('DO0001','IT1036',2,100);
/*!40000 ALTER TABLE `do_item` ENABLE KEYS */;
UNLOCK TABLES;
